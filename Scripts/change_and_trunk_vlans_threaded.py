...
# Set up thread count for number of threads to spin up. Change this to your own needs.
num_threads = 8
...
# CLI command being sent. This could be anywhere (and even be a passed parameter)
